...
export default {
  ...
  data: new SlashCommandBuilder()
    ...
    .addUserOption((option) => option.setName("exec").setDescription("Enter an exec to be yelled at (if they're ok with this!)").setRequired(true))
    .addStringOption((option) => option.setName("message").setDescription("Enter message to yell at an exec").setRequired(true))
    .addStringOption((option) => option.setName("channel").setDescription("Enter a channel to yell at an exec in").setRequired(true)),
